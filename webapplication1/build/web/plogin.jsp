...
<script type="text/javascript">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <nav id="menu">
					<ul>
						<li class="nav2"><a href="pregister.jsp">Register</a></li>							
						<li class="nav5" id="active"><a href="plogin.jsp">Login</a></li>
					</ul>
				</nav>
        </header>
                </div>
		...
		<div class="body6">
			<div class="main">
				<div class="wrapper">
					...
					<h2>Patients please <span>Login here</span>!</h2>
					</div>
			</div>
		</div>
	</div>
...
<article class="col2">
						<div class="pad1">
							<form id="RegForm" method="post" action ="patientlogin">
