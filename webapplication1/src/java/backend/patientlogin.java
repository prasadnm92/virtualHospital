...
public class patientlogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet patientlogin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet patientlogin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
                ...
                String patientname = null;
                 ...
                 try {
                       ...
                       //  query = "SELECT did, password FROM user WHERE username="" + did + "" AND password="" + password + "";";
                        ...
                        String getName;//this will avoid sql injection
                        getName = "SELECT name FROM patients WHERE username = ?";
                 ...
                 Cookie userName = new Cookie("patientname", username);
